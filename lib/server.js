...
var SapperOIDCClient = /** @class */ (function () {
    ...
    SapperOIDCClient.prototype.middleware = function () {
        ...
        return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var path, userHasValidSession, token, SID, _a, toBrowser, toStore, error_1, state, stateID, redirectURL, params, stateID, state, tokenSet, claimed, resultToStore, SID_1, error_2, error_3, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 6:
                        ...
                        if (!(path === this.authPath && req.method == "POST")) return [3 /*break*/, 8];
                        if (this.debug)
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 24];
                    case 8:
                        if (!(path === this.callbackPath && req.method == "POST")) return [3 /*break*/, 23];
                        if (this.debug)
