            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!!path.includes(".")) return [3 /*break*/, 23];
                    ...
                    case 4:
                        ...
                        if (dev)
                            console.log("Has a valid session");
                        return [3 /*break*/, 6];
                    case 5:
                        error_1 = _b.sent();
                        if (dev)
                        ...
                        return [3 /*break*/, 6];
                    case 6:
                        if (!!userHasValidSession) return [3 /*break*/, 23];
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 23];
                    case 8:
                        if (!(path === this.callbackPath)) return [3 /*break*/, 22];
                        if (dev)
                            console.log("/cb");
                    ...
                    case 22:
                        if (both_1.mustAuth(path, this.protectedPaths)) {
                            if (dev)
