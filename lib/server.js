...
var SapperOIDCClient = /** @class */ (function () {
    ...
    SapperOIDCClient.prototype.middleware = function () {
        ...
        return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var path, userHasValidSession, token, SID, result, toBrowser, toStore, claimed, toBrowser, error_1, state, stateID, error_2, redirectURL, params, stateID, state, tokenSet, claimed, resultToStore, SID_1, error_3, error_4, error_5, error_6, error_7, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = req.originalUrl.replace(/\?.*$/, "");
                        if (!(!path.includes(".") && path !== path.authFailedRedirectPath)) return [3 /*break*/, 40];
                    ...
                    case 9:
                        ...
                        if (!(path === this.authPath && req.method == "POST")) return [3 /*break*/, 14];
                    ...
                    case 13:
                        ...
                        return [3 /*break*/, 40];
                    case 14:
                        if (!(path === this.callbackPath && req.method == "POST")) return [3 /*break*/, 39];
                        _a.label = 15;
                    case 15:
