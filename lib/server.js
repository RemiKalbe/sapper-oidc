...
var SapperOIDCClient = /** @class */ (function () {
    ...
    SapperOIDCClient.prototype.middleware = function () {
        ...
        return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var path, userHasValidSession, token, SID, _a, toBrowser, toStore, toBrowser, error_1, state, stateID, redirectURL, params, stateID, state, tokenSet, claimed, resultToStore, SID_1, error_2, error_3, error_4;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (this.debug)
                            log("Request " + path);
                        if (!(!path.includes(".") && path !== path.authFailedRedirectPath)) return [3 /*break*/, 26];
                        if (this.debug)
                    ...
                    case 2:
                        _b.trys.push([2, 7, , 8]);
                        if (!(token.expires_at &&
                            token.expires_at * 1000 - Date.now() <= 600000)) return [3 /*break*/, 5];
                        if (this.debug)
                    ...
                    case 7:
                        ...
                        return [3 /*break*/, 8];
                    case 8:
                        if (!!userHasValidSession) return [3 /*break*/, 26];
                        if (this.debug)
                            log("doesn't have a valid session");
                        if (!(path === this.authPath && req.method == "POST")) return [3 /*break*/, 10];
                        if (this.debug)
                    ...
                    case 9:
                        ...
                        return [3 /*break*/, 26];
                    case 10:
                        if (!(path === this.callbackPath && req.method == "POST")) return [3 /*break*/, 25];
                        if (this.debug)
                        ...
                        stateID = req.body.stateID;
                        if (!(stateID === undefined || stateID === "")) return [3 /*break*/, 11];
                        if (this.debug)
                    ...
                    case 22:
                        if (this.debug)
                            log("end");
                        res.end(JSON.stringify({ url: this.authSuccessfulRedirectPath }));
                        return [3 /*break*/, 24];
                    case 23:
                        error_4 = _b.sent();
                        res.redirect(this.authFailedRedirectPath);
