...
var SapperOIDCClient = /** @class */ (function () {
    ...
    SapperOIDCClient.prototype.middleware = function () {
        ...
        return function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var path, userHasValidSession, token, SID, result, toBrowser, toStore, claimed, toBrowser, error_1, state, stateID, redirectURL, error_2, params, stateID, state, tokenSet, claimed, resultToStore, SID_1, error_3, error_4, error_5, error_6, error_7, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = req.originalUrl.replace(/\?.*$/, "");
                        if (!!path.includes(".")) return [3 /*break*/, 40];
                        // Polka doesn't have res.redirect
                        res.redirect = function (location) {
                            res.end("<meta http-equiv=\"refresh\" content=\"0;URL=" + (req.headers.origin ? req.headers.origin : "" + location) + "\">");
                        };
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 9];
                    case 9:
                        if (!!userHasValidSession) return [3 /*break*/, 40];
                        if (!(path === this.authPath)) return [3 /*break*/, 14];
                    ...
                    case 14:
                        if (!(path === this.callbackPath)) return [3 /*break*/, 39];
                        _a.label = 15;
                    case 15:
                        _a.trys.push([15, 37, , 38]);
                        params = this.client.callbackParams(req);
                        stateID = getStateFromCookie(req);
                        if (!(stateID === null || stateID === undefined || stateID === "")) return [3 /*break*/, 16];
                        log("Error: No state found");
                        req.error = "NO_STATE_FOUND_IN_REQ";
                        res.redirect(this.authFailedRedirectPath);
                        return [3 /*break*/, 36];
                    case 16:
                        _a.trys.push([16, 35, , 36]);
                        return [4 /*yield*/, this.redis.get(stateID)];
                    case 17:
                        state = _a.sent();
                        if (!state) return [3 /*break*/, 33];
                        _a.label = 18;
                    case 18:
                        _a.trys.push([18, 31, , 32]);
...
function getStateFromCookie(req) {
    return req.headers.cookie ? cookie_1.parse(req.headers.cookie).state : undefined;
}
function getTokenSetFromCookie(req, redisClient) {
    return __awaiter(this, void 0, void 0, function () {
        var SID, result, tokenSet, error_9, error_10;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    SID = getSIDFromCookie(req);
...
function getRefreshedTokenSetAndClaims(tokenSet, client) {
    return __awaiter(this, void 0, void 0, function () {
        var refreshedTokenSet, claimed, resultToStore, resultToBrowser, error_11;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
