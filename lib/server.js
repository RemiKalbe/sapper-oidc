            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!path.includes(".")) return [3 /*break*/, 44];
                    ...
                    case 9:
                        ...
                        return [3 /*break*/, 10];
                    case 10:
                        if (!!userHasValidSession) return [3 /*break*/, 44];
                    ...
                    case 15:
                        ...
                        _a.label = 16;
                    case 16: return [3 /*break*/, 44];
                    case 17:
                        if (!(path === this.callbackPath && req.method == "POST")) return [3 /*break*/, 44];
                        _a.label = 18;
                    case 18:
