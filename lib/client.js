...
exports.pathGuard = exports.silentRenew = void 0;
        ...
        return __generator(this, function (_a) {
            if (window !== undefined) {
                if (user !== null && user !== undefined) {
                    expIn = user.raw.expires_at * 1000 - Date.now() - 100;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    refresh(json.raw.expires_at * 1000 - Date.now() - 100, callback, refreshPath);
