...
exports.silentLogin = exports.silentCallback = exports.callback = exports.auth = exports.pathGuard = exports.silentRenew = void 0;
...
function silentCallback(goto, callback) {
    var stateID = localStorage.getItem("stateID");
    var back = localStorage.getItem("where_at");
    localStorage.removeItem("stateID");
    if (stateID) {
...
function silentLogin() {
    if (window) {
        ...
        var back = urlParams.get("where_at");
        if (back && redirect_to && stateID) {
            var whereAt = window.atob(back);
